...
<div class="home">
		<div class="section-one">
            ...
            <div class="center-square">
				...
				?>
                <div class="row">
					<div class="column"><?php echo $row['fld_userName'];?></div>
					<div class="column"><?php echo $row['fld_quizName'];?></div>
					<div class="column"><?php echo $row['fld_score'];?></div>
                </div>
				<?php
					}
